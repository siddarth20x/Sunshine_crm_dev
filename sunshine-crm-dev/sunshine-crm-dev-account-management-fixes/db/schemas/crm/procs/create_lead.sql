...
VALUES
       ...
       account_number= IFNULL(in_account_number, account_number),
       ...
       lead_id = LAST_INSERT_ID(lead_id);

SET
       out_lead_id = LAST_INSERT_ID();
