...
@Component({
  selector: 'app-mol-check-tab',
  templateUrl: './mol-check-tab.component.html',
  styleUrls: ['./mol-check-tab.component.css'],
  animations: [
...
export class MolCheckTabComponent implements OnInit {
