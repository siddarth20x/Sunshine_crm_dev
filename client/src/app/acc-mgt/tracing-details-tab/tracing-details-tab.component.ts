...
@Component({
  selector: 'app-tracing-details-tab',
  templateUrl: './tracing-details-tab.component.html',
  styleUrls: ['./tracing-details-tab.component.css'],
  animations: [
...
export class TracingDetailsTabComponent implements OnInit {
  ...
  moduleName: string = 'WEB_TRACING_DETAILS';
  ...
  captureRouteParams() {
    ...
    this.leadId = lead_id;
    this.getAllWebTracingDetails(lead_id);
  }

  getAllWebTracingDetails(leadId: number) {
