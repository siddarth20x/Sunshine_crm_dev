...
-- SELECT user.fn_get_last_activity_after_upload(76,"2025-02-21","2025-02-25");
-- SELECT user.fn_get_last_activity_after_upload(78,"2025-02-24","2025-02-25");

DELIMITER $$

DROP FUNCTION IF EXISTS user.fn_get_last_activity_after_upload$$

CREATE FUNCTION user.fn_get_last_activity_after_upload( in_lead_id BIGINT, 
