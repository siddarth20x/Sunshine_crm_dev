...
CREATE TABLE `location` (
  ...
  `location_name` varchar(200) COLLATE utf8mb4_bin NOT NULL,
  `location_type_id` mediumint NOT NULL,
  `location_code` varchar(10) COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  UNIQUE KEY `u_location_name_company_id` (`location_name`,`company_id`),
  ...
  CONSTRAINT `fk_location_location_type` FOREIGN KEY (`location_type_id`) REFERENCES `location_type` (`location_type_id`)
