...
CREATE TABLE `notes` (
  ...
  PRIMARY KEY (`note_id`),
  KEY `fk_notes_leads_idx` (`lead_id`),
  KEY `fk_notes_leads` (`lead_id`),
  CONSTRAINT `fk_notes_leads` FOREIGN KEY (`lead_id`) REFERENCES `leads` (`lead_id`)
