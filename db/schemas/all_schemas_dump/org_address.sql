...
CREATE TABLE `address` (
  ...
  `address_name` varchar(100) COLLATE utf8mb4_bin NOT NULL,
  `address_type_id` mediumint NOT NULL,
  `address_line_1` varchar(500) COLLATE utf8mb4_bin NOT NULL,
  `address_line_2` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  `address_line_3` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `zipcode` varchar(45) COLLATE utf8mb4_bin NOT NULL,
  ...
  UNIQUE KEY `u_location_id_address_type_id` (`location_id`,`address_type_id`),
  KEY `fk_address_address_type` (`address_type_id`),
  KEY `fk_address_location` (`location_id`),
