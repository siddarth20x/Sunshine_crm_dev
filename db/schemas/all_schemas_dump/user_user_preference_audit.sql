...
CREATE TABLE `user_preference_audit` (
  ...
  `user_preference_id` bigint DEFAULT NULL,
  `user_id` bigint DEFAULT NULL,
  `preferred_module_ids` text COLLATE utf8mb3_bin,
  `preferred_notification_type_ids` text COLLATE utf8mb3_bin,
...
--
-- Dumping data for table `user_preference_audit`
--

LOCK TABLES `user_preference_audit` WRITE;
/*!40000 ALTER TABLE `user_preference_audit` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_preference_audit` ENABLE KEYS */;
UNLOCK TABLES;
