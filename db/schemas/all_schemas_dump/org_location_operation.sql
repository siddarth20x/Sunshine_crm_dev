...
--
-- Table structure for table `location_operation`
--
...
CREATE TABLE `location_operation` (
  ...
  `location_end_date` datetime NOT NULL DEFAULT '2100-12-31 00:00:00',
  ...
  UNIQUE KEY `u_location_id` (`location_id`),
  KEY `fk_location_operation_location` (`location_id`),
  CONSTRAINT `fk_location_operation_location` FOREIGN KEY (`location_id`) REFERENCES `location` (`location_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `location_operation`
--

LOCK TABLES `location_operation` WRITE;
/*!40000 ALTER TABLE `location_operation` DISABLE KEYS */;
/*!40000 ALTER TABLE `location_operation` ENABLE KEYS */;
UNLOCK TABLES;
