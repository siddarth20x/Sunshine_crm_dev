...
CREATE TABLE `contact` (
  ...
  `contact_mode_list` varchar(1000) COLLATE utf8mb4_bin NOT NULL,
  `designation` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `salutation` varchar(45) COLLATE utf8mb4_bin NOT NULL,
  ...
  `phone_ext` varchar(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `alternate_phone` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  KEY `fk_contact_contact_dept_type` (`contact_dept_type_id`),
  KEY `fk_contact_company` (`company_id`),
  CONSTRAINT `fk_contact_company` FOREIGN KEY (`company_id`) REFERENCES `company` (`company_id`),
  CONSTRAINT `fk_contact_contact_dept_type` FOREIGN KEY (`contact_dept_type_id`) REFERENCES `contact_dept_type` (`contact_dept_type_id`)
