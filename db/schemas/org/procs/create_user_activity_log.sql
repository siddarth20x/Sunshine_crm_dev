-- call org.create_user_activity_log (@err,2,"CREATE_org",1,1,'org name',CURRENT_TIMESTAMP,@osuid);

DROP PROCEDURE IF EXISTS org.create_user_activity_log;

DELIMITER $$
CREATE PROCEDURE org.create_user_activity_log(OUT error_code INT
...
INSERT INTO org.user_activity_log
       ( 
